...
class NewDocumentsRecycleViewAdapter(private val viewModel: ReservationViewModel, private val templates: Array<String>): BaseRecyclerViewAdapter<ItemNewDocumentBinding>() {
    ...
    override fun setView(position: Int) {
        val splitString = templates[position].split("|")
